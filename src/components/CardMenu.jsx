...
export default function CardMenu({ i, nama, menu, harga, gambar, progres, range, targetScale }) {
    ...
    return (
        <div className='h-[100vh] flex items-center justify-center sticky pb-20 top-0'>
            <motion.div 
                ...
                <div className="my-5 md:mr-5 md:ml-10 mx-2 md:w-full">
                    ...
                    <h1 className="md:text-lg text-base font-normal mt-2 text-gray-400">{menu.length} Product{menu.length > 1 ? 's' : ''}</h1>
