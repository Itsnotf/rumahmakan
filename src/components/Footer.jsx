...
export default function Footer() {
    return (
        <div
            className='relative  bg-[#E4E7C4]   h-[800px]'
            style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}>
            <div className='fixed bottom-0 lg:mx-20  mx-0 md:mx-6 sm:mx-10 h-[800px] w-full   '>
                ...
                <div className='flex md:flex-row flex-col md:items-start items-center text-center md:text-left  justify-between w-[100%] md:w-[90%] h-full md:my-60 my-56 '>
                    <div className='hidden md:flex flex-col text-[#4F6C51]'>
                        <h1 className='text-5xl font-bold'>Link Cepat</h1>
                        <ul className='text-xl flex flex-col gap-5 mt-5'>
                    ...
                    <div className="w-72 h-72 mb-60 md:w-[600px] md:h-[450px]">
